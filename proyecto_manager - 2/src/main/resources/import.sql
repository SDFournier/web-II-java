INSERT INTO `user` (`id`,`enabled`,`password`,`username`) VALUES (1,b'1',"$2a$10$xGZH6mmL3oZe71kArzhX9eoFN2NKhXrYwrhwMw4faMHczWypLu9gC","Seba");
...
INSERT INTO `desarrollador` (`nombre`, `numero`, `persona_id`) VALUES ('Messi', '10', '1');
INSERT INTO `desarrollador` (`nombre`, `numero`, `persona_id`) VALUES ('Neymar', '34', '1');
INSERT INTO `desarrollador` (`nombre`, `numero`, `persona_id`) VALUES ('Martinez', '1', '1');
INSERT INTO `desarrollador` (`nombre`, `numero`, `persona_id`) VALUES ('Otamendi', '2', '1');
INSERT INTO `desarrollador` (`nombre`, `numero`, `persona_id`) VALUES ('Ronaldo', '44', '1');
INSERT INTO `desarrollador` (`nombre`, `numero`, `persona_id`) VALUES ('Gutierrez', '101', '1');
INSERT INTO `desarrollador` (`nombre`, `numero`, `persona_id`) VALUES ('Martinez', '1', '1');
INSERT INTO `desarrollador` (`nombre`, `numero`, `persona_id`) VALUES ('Otamendi', '2', '1');
INSERT INTO `desarrollador` (`nombre`, `numero`, `persona_id`) VALUES ('Ronaldo', '44', '1');